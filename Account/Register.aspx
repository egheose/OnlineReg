...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        <div class="row">
            <br />
        <h1 style="position:relative;left:15px;font-size:24px;font-weight:bold">Personal Info</h1>
            <div class="box_wrapper">
                <div class="left">
                    <div class="active" id="pi">Personal Info</div>
                    <div class="disabled" id="pic">Personal Info (Contd)</div>
                    <div class="disabled" id="ci">Contact Info</div>
                    <div class="disabled" id="ei">Employment Info</div>
                    <div class="disabled" id="oi">Other Info</div>
                </div>
        <div class="box_content_right right">
